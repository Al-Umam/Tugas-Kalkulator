...
namespace kalkulator Umam
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Aplikasi Calculator desain dinamis terdapat menu pilihan";
            int pilihan;

            Console.Write("Program Kalkulator Sederhana yang dinamis dan ada menu pilihannya");
            Console.WriteLine();
            Console.Write("============================");
            Console.WriteLine();
            Console.Write(" Pilih Menu :");
            Console.WriteLine();
            Console.Write("1.Menu Pertambahan");
            Console.WriteLine();
            ...
            Console.Write("Pilih Nomor berapa yang diiinginkan (1-4) = ");
            pilihan = int.Parse(Console.ReadLine());
			// gaskeun kalkulator dinamis dan ada pilihan menu yang disediakan oleh kami
            if (pilihan == 1 || pilihan == 1)
            {
                ...
                Console.WriteLine("Hasil Pertambahan " + a + " + " + b + " = " + Pertambahan(a, b));
            }
